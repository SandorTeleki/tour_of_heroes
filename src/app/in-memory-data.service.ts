...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const heroes = [
      ...
      // { id: 541, name: 'Sleep Breather', superpower: 'Stops villains from breathing during their sleep', age: 31},
      ...
      // { id: 557, name: 'Dector Challenger', superpower: 'Can challenge anyone', age: 16},
      ...
      // { id: 565, name: 'Decide RR', superpower: 'Decisions, decisions', age: 27},
      ...
      // { id: 576, name: 'Upper Pants', superpower: 'Legally distinct powers of upper garments', age: 18},
      ...
      // { id: 586, name: 'Ten Tickles', superpower: 'Power of tentacles', age: 24},
      // { id: 587, name: 'Polite Ticks', superpower: 'Made up of ticks', age: 32},
      // { id: 588, name: 'Swing Tracker', superpower: 'Tracks motion without emotions', age: 25},
      ...
      // { id: 593, name: 'Chocolate Ball', superpower: 'Rolls with the power of chocolate', age: 27},
      // { id: 594, name: 'Vanilla Bar', superpower: 'Bars of spice, comments of steel', age: 24},
      // { id: 595, name: 'Car Vine', superpower: 'Plant based vehicular hero', age: 23},
      ...
      // { id: 600, name: 'Ay Vee R', superpower: 'Responds to every and any call', age: 45},
      // { id: 601, name: 'Phy N', superpower: 'Makes things okay', age: 42},
      // { id: 602, name: 'Dee Phi', superpower: 'Defies expectation', age: 29},
      ...
      // { id: 610, name: 'Star Dusk', superpower: 'Darkness of stars', age: 36},
      // { id: 611, name: 'Nuke Juke', superpower: 'Power of nuclear reactions', age: 34},
      // { id: 612, name: 'Pressure Fissure', superpower: 'Creates wholes in things', age: 41},
      ...
      // { id: 617, name: 'OnKallrrr', superpower: 'Always on-call', age: 31},
      // { id: 618, name: 'InKallrrr', superpower: 'Always in a call for on-call', age: 26},
      // { id: 619, name: 'Tempo Brr', superpower: 'Always on tempo', age: 31},
      // { id: 620, name: 'Xakphone', superpower: 'Instrumental hero', age: 23},
      ...
      // { id: 625, name: 'Tongue Burner', superpower: 'Burns lying tongues', age: 26},
      // { id: 626, name: 'Maximus Chadicus', superpower: 'Power of positive chadness', age: 23},
      // { id: 627, name: 'Bro Max', superpower: 'Maximum broness', age: 18},
      // { id: 628, name: 'Brosky Math', superpower: 'Bro math', age: 17},
      ...
      // { id: 635, name: 'Lumpy Lump', superpower: 'Lumps enemies into blobs', age: 31},
      // { id: 636, name: 'Lampy', superpower: 'Light in the dark', age: 26},
      // { id: 637, name: 'Barbary Bard Yar', superpower: 'Looting villains with flair', age: 24},
      // { id: 638, name: 'T. Knee', superpower: 'Tiniest hero', age: 21},
      // { id: 639, name: 'Koolooh', superpower: 'Power of cool', age: 25},
      ...
      // { id: 644, name: 'Rebake the Retake', superpower: 'Rebakes half finished ideas', age: 36},
      // { id: 645, name: 'Squiggle Giggle', superpower: 'Heroic doodles', age: 12},
      // { id: 646, name: 'Tree Knight', superpower: 'Steed of vines, arms of trunks', age: 45},
      // { id: 647, name: 'Redest Green', superpower: 'Speed of nature', age: 20},
      // { id: 648, name: 'Freshest Loser', superpower: 'Never a sore loser', age: 19},
      // { id: 649, name: 'Sorest Winner', superpower: 'Always a sore winner', age: 19},
      // { id: 650, name: 'Sane Ears', superpower: 'Sanity in hearing', age: 26},
      ...
      // { id: 655, name: 'Zzz Rester', superpower: 'Makes everyone rest', age: 66},
      // { id: 656, name: 'Pffftinator', superpower: 'Power of disbelief', age: 32},
      // { id: 657, name: 'Pssstinator', superpower: 'Power of shushing anyone', age: 11},
      // { id: 658, name: 'Dart Tears', superpower: 'Tearducts shoot darts', age: 20},
      ...
      // { id: 680, name: 'Solid Blood', superpower: 'Blood spikes', age: 19},
      // { id: 681, name: 'BroCooleeh', superpower: 'Coolest broccoli', age: 2},
      // { id: 682, name: 'Saint Coal', superpower: 'Meanest Santa', age: 780},
      // { id: 683, name: 'Box Thrower', superpower: 'Can throw boxes anywhere', age: 54},
      // { id: 684, name: 'One in Gone', superpower: 'Gone with the weather', age: 32},
      // { id: 685, name: 'Void Ear', superpower: 'Can hear anything', age: 51},
      // { id: 686, name: 'Hard Feed', superpower: 'Can survive on anything', age: 32},
      ...
      // { id: 694, name: 'Con Fuse Or', superpower: 'Confuses enemies and allies', age: 32},
      ...
      // { id: 703, name: 'Elavator Pitcher', superpower: 'Pitches faster than an elevator', age: 43},
      ...
      // { id: 717, name: 'Binding Chip', superpower: 'Chips of binding paint to catch villains', age: 31},
      // { id: 718, name: 'Chirip Kit', superpower: 'Chirps through objects', age: 22},
      // { id: 719, name: 'Three Steps', superpower: 'Three steps ahead of enemies', age: 33},
      // { id: 720, name: 'Quintuped', superpower: 'Five feeth to defeat villains with', age: 55},
      ...
      // { id: 725, name: 'Ticking Bomb', superpower: 'Explosive ticks', age: 24},
      ...
      // { id: 758, name: 'Grenade Nose', superpower: 'Explosive sneezes', age: 35},
      ...
      // { id: 785, name: 'Monkey Key', superpower: 'Can open any window', age: 25},
      // { id: 786, name: 'Snitch Stitcher', superpower: 'Does what the saying says', age: 34},
      // { id: 787, name: 'Hug Dispenser', superpower: 'Hugs enemies to complacency, consensually', age: 53},
      // { id: 788, name: 'Fake Goals', superpower: 'Turns enemy goals into jokes', age: 64},
      ...
      // { id: 818, name: 'X-I', superpower: 'Crosses enemy eyes', age: 44},
      // { id: 819, name: 'Fluffy Scorpion', superpower: 'Cuddly and dangerous', age: 9},
      // { id: 820, name: 'Basic Acid', superpower: 'Kills with pH neutrality!', age: 20},
      // { id: 821, name: 'Trx', superpower: 'Tricks enemies', age: 16},
      // { id: 822, name: 'Coat Liner', superpower: 'Lines coats with money', age: 23},
      // { id: 823, name: 'Can Fish', superpower: 'Shoots fish from cans, heroically', age: 24},
      // { id: 824, name: 'Very Intersting Potato', superpower: 'VIP of heroic veggies', age: 2},
      // { id: 825, name: 'Very Intersting Carrot', superpower: 'VICtory of orange color', age: 31},
      // { id: 826, name: 'Sleeve Pen', superpower: 'Shoots ink from sleeves', age: 28},
      ...
      // { id: 831, name: 'Rest Tester', superpower: 'Tests how rested enemies are', age: 53},
      // { id: 832, name: 'Snail Knight', superpower: 'Slowest, but strongest knight', age: 62},
      // { id: 833, name: 'Fixit Fred', superpower: 'Fixes anything', age: 49},
      ...
      // { id: 839, name: 'Nick Ql', superpower: 'Throws quality coins at enemies', age: 35},
      // { id: 840, name: 'Zord', superpower: 'Lord of the letter Z', age: 41},
      // { id: 841, name: 'Big Baby', superpower: 'Debuffs enemies with temper tantrums', age: 20},
      ...
      // { id: 848, name: 'Seven Fingers', superpower: 'A finger in every plot', age: 53},
      // { id: 849, name: '$UP', superpower: 'Floats on any body of water', age: 39},
      // { id: 850, name: 'Finger Knees', superpower: 'Knees that achieve the impossible', age: 47},
      // { id: 851, name: 'Harmful Aid', superpower: 'Harms villians by aiding them', age: 65},
      // { id: 852, name: 'Drunk Sobriety', superpower: 'Drunken fists with no booze', age: 49},
      // { id: 853, name: 'Peaceful Violence', superpower: 'Peacefully violent', age: 33},
      // { id: 854, name: 'OG Cook', superpower: 'LET HIM COOK!', age: 30},
      // { id: 855, name: 'Dark Lamp', superpower: 'Darkens brightness, brightens darkness', age: 56},
      // { id: 856, name: 'Nuclear Summer', superpower: 'Heroic radiation and heat in one hero', age: 48},
      // { id: 857, name: 'Scorching Winter', superpower: 'Burning cold', age: 84},
      ...
      // { id: 870, name: 'Droll Voice', superpower: 'Bores enemies to death' age: 80},
      // { id: 871, name: 'Zol Krack', superpower: 'Demonic attacks' age: 45},
      // { id: 872, name: 'Sack Track', superpower: 'Sacks anything that moves on tracks' age: 53},
      ...
      // { id: 877, name: 'Pepper Pincher', superpower: 'Causes uncontrollable sneezing' age: 52},
      // { id: 878, name: 'Zap Sick', superpower: 'Zaps enemies with sickness' age: 71},
      ...
      // { id: 883, name: 'Dream Cream', superpower: 'Removes sourness from enemies' age: 26},
      // { id: 884, name: 'Solid Soup', superpower: 'Sustains other heroes indefinitely' age: 48},
      // { id: 885, name: 'Changing Cup', superpower: 'Power of changing fluids' age: 38},
      ...
      // { id: 894, name: 'Boss Servant', superpower: 'Household confusion and power' age: 53},
      ...
      // { id: 913, name: 'Eleventh Hour', superpower: 'Last minute power ups' age: 68},
      // { id: 914, name: 'Last Second', superpower: 'Can only finish tasks in the last second' age: 60},
      // { id: 915, name: 'Troll Drool', superpower: 'Healing drool' age: 45},
      ...
      // { id: 919, name: 'Pretzel Wrapper', superpower: 'Wraps everyone into a pretzel' age: 32},
      // { id: 920, name: 'Fire Hire', superpower: 'Best work when fired' age: 19},
      // { id: 921, name: 'Rock Swimmer', superpower: 'Swims through rocks' age: 39},
      // { id: 922, name: 'Threadsnapper', superpower: 'Snaps any and all threads' age: 47},
      // { id: 923, name: 'Basketflier', superpower: 'Can fly inside a basket' age: 51},
      // { id: 924, name: 'Tablejumper', superpower: 'As long as tables are involved, can jump anywhere' age: 44},
      ...
      // { id: 936, name: 'Snotslinger', superpower: 'Annoys enemies with endless snot' age: 32},
      // { id: 937, name: 'Deepriser', superpower: 'Rises unexpectedly up to any challenge' age: 43},
      // { id: 938, name: 'Joketrapper', superpower: 'Traps enemies with jokes' age: 51},
      // { id: 939, name: 'Fuginator', superpower: 'Fudges enemy plans' age: 74},
      // { id: 940, name: 'Lioneagle', superpower: 'Combines the majesty of lions with eagles, heroically' age: 56},
      ...
      // { id: 948, name: 'Prolanis', superpower: 'Professional laminated hero' age: 20},
